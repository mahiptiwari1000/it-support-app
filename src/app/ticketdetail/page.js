...
const TicketDetail = () => {
  ...
  const [ticket, setTicket] = useState({
    ...
    messages: [
      {
        sender: 'Assignee',
        content: 'Please provide details on how the issue started.',
        timestamp: '2023-11-04 10:30 AM',
      },
      {
        sender: 'Requestor',
        content: 'It started suddenly this morning. No changes made to the setup.',
        timestamp: '2023-11-04 10:45 AM',
      },
      {
        sender: 'Assignee',
        content: 'Thank you. Checking the server room now.',
        timestamp: '2023-11-04 11:00 AM',
      },
    ],
    logs: [
  ...
  const handleSendMessage = () => {
    if (newMessage.trim()) {
      ...
      setTicket((prevTicket) => ({
        ...
        status: 'Pending', // Automatically change status to Pending
      }));
